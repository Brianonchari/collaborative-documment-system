...
class CommentService(
    ...
    fun addComment(request: CreateCommentRequest): CommentResponse {
        var document = documentRepository.findById(request.documentId).orElseThrow { ->
    ...
    fun getCommentsForDocument(documentId: UUID, page: Int, size: Int): PagedResponse<CommentResponse> {
